...
from sqltables.djangobase.expressions_22 import Col, F, Ref, SimpleCol
...
# )
from sqltables.djangobase.datastructures_22 import BaseTable, Empty, Join, MultiJoin
# from django.db.models.sql.where import (
#     AND, OR, ExtraWhere, NothingNode, WhereNode,
# )
from sqltables.djangobase.where_22 import AND, OR, ExtraWhere, NothingNode, WhereNode
...
class Query:
    ...
    def get_aggregation(self, using, added_aggregate_names):
        ...
        if (isinstance(self.group_by, tuple) or has_limit or has_existing_annotations or
            ...
            from .djangobase.subqueries_22 import AggregateQuery
